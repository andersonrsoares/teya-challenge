...
internal class TopAlbumsListViewModel(
    ...
    eventStateContext: EventStateContextHolder<TopAlbumsListState, TopAlbumsListEvent>,
): EventViewModelHolder<TopAlbumsListState, TopAlbumsListEvent>(eventStateContext) {
